        ...
        <div className="matrix-login-container max-w-md w-full space-y-8">
          ...
          <div className="text-center">
            <div className="matrix-subtitle">
              <p className="text-yellow-400 font-mono text-sm mb-2">&gt; WELCOME TO RAINMAKERS PORTAL</p>
          ...
          <div className="space-y-4">
            ...
            <button
              onClick={() => window.open('https://whop.com/rainmakers/', '_blank')}
              className="matrix-button-secondary group relative w-full flex justify-center py-4 px-6 text-lg font-bold rounded-lg transition-all duration-300"
            >
              <div className="flex items-center">
                <svg className="w-6 h-6 mr-3" viewBox="0 0 24 24" fill="currentColor">
